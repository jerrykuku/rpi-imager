...
ApplicationWindow {
    ...
    title: {
        var baseTitle = qsTr("ZimaOS Imager %1").arg(imageWriter.constantVersion())
        if (isOffline) {
    ...
    BaseDialog {
        ...
        Text {
            id: quitMessage
            text: qsTr("ZimaOS Imager is still busy. Are you sure you want to quit?")
            font.pixelSize: Style.fontSizeDescription
            font.family: Style.fontFamily
            color: Style.textDescriptionColor
            wrapMode: Text.WordWrap
        ...
        RowLayout {
            ...
            ImButton {
                ...
                accessibleDescription: qsTr("Return to ZimaOS Imager and continue the current operation")
                activeFocusOnTab: true
            ...
            ImButtonRed {
                ...
                accessibleDescription: qsTr("Force quit ZimaOS Imager and cancel the current write operation")
                activeFocusOnTab: true
                onClicked: {
    ...
    BaseDialog {
        ...
        RowLayout {
            ...
            ImButton {
                ...
                accessibleDescription: qsTr("Install system authorization to allow ZimaOS Imager to run with elevated privileges")
                activeFocusOnTab: true
            ...
            ImButtonRed {
                id: exitButton
                text: qsTr("Exit")
                accessibleDescription: qsTr("Exit ZimaOS Imager - you must restart with elevated privileges to write images")
                activeFocusOnTab: true
                onClicked: Qt.quit()
            }
        }
